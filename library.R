...
offense.codes <- read.delim('src/offense-codes.tsv', header=FALSE, col.names=c('code','offense'))
...
arrest.offenses <- read.delim('src/arrest.offenses.tsv', header=FALSE, col.names=c('real.offense','nominal.offense'))
