...
offense.codes <- read.delim('data_hw3/offense-codes.tsv', header=FALSE, col.names=c('code','offense'))
...
arrest.offenses <- read.delim('data_hw3/arrest.offenses.tsv', header=FALSE, col.names=c('real.offense','nominal.offense'))
